...
func registerUser(context *gin.Context) {
	...
	if err := context.BindJSON(&user); err != nil {
		context.JSON(http.StatusBadRequest, helpers.GenerateError("invalid json", err, gin.DefaultErrorWriter))
		return
	}
...
func updateUser(context *gin.Context) {
	...
	if !ok {
		context.JSON(http.StatusBadRequest, helpers.GenerateError("invalid user", err, gin.DefaultErrorWriter))
		return
	}
